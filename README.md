This code was compiled by three students, in order to review Motion for React JS. 

The bulk of the code was created by "M", from a prior project on creating an image gallery using Vite with a backend and front end.
